...
$_RUNJAVA -Dskywalking.agent.application_code=dmp-demo-eureka-service -jar $DEMO_HOME/eureka-service/eureka-service.jar 2>/dev/null 1> /dev/null &
...
if [ -f "${AGENT_DIR}/skywalking-agent.jar" ]; then
    PROJECTB_OPTS="-javaagent:${AGENT_DIR}/skywalking-agent.jar -Dskywalking.agent.application_code=dmp-demo-projectB-service -Dskywalking.collector.grpc_channel_check_interval=2 -Dskywalking.collector.app_and_service_register_check_interval=2 -Dcollector.discovery_check_interval=2 -Dskywalking.collector.servers=${COLLECTOR_SERVER_LIST} -Dskywalking.agent.application_code=projectB"
fi
...
if [ -f "${AGENT_DIR}/skywalking-agent.jar" ]; then
    PROJECTC_OPTS="-javaagent:${AGENT_DIR}/skywalking-agent.jar -Dskywalking.agent.application_code=dmp-demo-project-Cservice  -Dskywalking.collector.grpc_channel_check_interval=2 -Dskywalking.collector.app_and_service_register_check_interval=2 -Dcollector.discovery_check_interval=2 -Dskywalking.collector.servers=${COLLECTOR_SERVER_LIST} -Dskywalking.agent.application_code=projectC"
fi
...
if [ -f "${AGENT_DIR}/skywalking-agent.jar" ]; then
    PROJECTD_OPTS="-javaagent:${AGENT_DIR}/skywalking-agent.jar -Dskywalking.agent.application_code=dmp-demo-projectD-service -Dskywalking.collector.grpc_channel_check_interval=2 -Dskywalking.collector.app_and_service_register_check_interval=2 -Dcollector.discovery_check_interval=2 -Dskywalking.collector.servers=${COLLECTOR_SERVER_LIST} -Dskywalking.agent.application_code=projectD"
fi
...
if [ -f "${AGENT_DIR}/skywalking-agent.jar" ]; then
    PROJECTA_OPTS="-javaagent:${AGENT_DIR}/skywalking-agent.jar -Dskywalking.agent.application_code=dmp-demo-projectA-service -Dskywalking.collector.grpc_channel_check_interval=2 -Dskywalking.collector.app_and_service_register_check_interval=2 -Dcollector.discovery_check_interval=2 -Dskywalking.collector.servers=${COLLECTOR_SERVER_LIST} -Dskywalking.agent.application_code=projectA"
fi
